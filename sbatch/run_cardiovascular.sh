...
#SBATCH --output=./slurm_out/cardio_remove_one_hop_no_seed11.txt
#SBATCH --error=./slurm_out/cardio_remove_one_hop_no_seed11.txt
...
python ../script/run.py -s 11 -c ../config/transductive/primekg/cardiovascular.yaml --gpus [0] 
