...
#SBATCH --output=./slurm_out/job_output_anemia.txt
#SBATCH --error=./slurm_out/job_error_anemia.txt
...
python ../script/run.py -c ../config/transductive/primekg/anemia.yaml --gpus [0] 
